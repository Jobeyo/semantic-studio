...
export default function DashboardPage() {
  ...
  const cards = [
    { title: 'Affärsmodeller', description: 'Skapa och hantera semantiska modeller', href: '/models', icon: Database, color: 'bg-indigo-50 text-indigo-600' },
      ...
      <div className="flex-1 overflow-y-auto p-8">
        ...
        <div className="mt-8 max-w-3xl">
          <div className="bg-indigo-600 rounded-xl p-6 flex items-center justify-between">
            <div>
              <h3 className="text-white font-semibold mb-1">{modelCount > 0 ? 'Skapa en affärsmodell' : 'Skapa din första semantiska modell'}</h3>
